...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginForm) => {
    try {
      ...
      toast({ title: result.detail || 'Welcome back!', description: 'You have been logged in successfully.' });
      navigate('/app');
    } catch (error) {
      toast({
        title: 'Login failed',
      ...
      <div className="hidden lg:flex flex-1 hero-gradient items-center justify-center p-12">
        ...
        >
          ...
          <p className="text-lg opacity-80 max-w-md">
            Join thousands of investors building wealth through share-based crowdfunding.
          </p>
        </motion.div>
      </div>
    </div>
