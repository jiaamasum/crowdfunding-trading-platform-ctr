...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: 'Pending Reviews', value: pendingProjects.length, icon: FileCheck, color: 'text-warning', bgColor: 'bg-warning/10', link: '/app/admin/projects/review-queue' },
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Quick Actions */}
      {(pendingProjects.length > 0 || pendingAccessCount > 0) && (
              ...
              {pendingProjects.length > 0 && (
                <Link to="/app/admin/projects/review-queue">
                  <Button variant="outline" className="gap-2">
                    {pendingProjects.length} project(s) awaiting review <ArrowRight className="h-4 w-4" />
                  </Button>
                </Link>
              )}
