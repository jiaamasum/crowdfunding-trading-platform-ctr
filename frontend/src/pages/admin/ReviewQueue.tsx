  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">Review and approve project submissions</p>
      </div>

      <Tabs defaultValue="pending">
        <TabsList>
          <TabsTrigger value="pending" className="gap-2">
            <Clock className="h-4 w-4" /> Pending ({pendingProjects.length})
          </TabsTrigger>
          <TabsTrigger value="reviewed" className="gap-2">
            <FileCheck className="h-4 w-4" /> Reviewed
          </TabsTrigger>
        </TabsList>
