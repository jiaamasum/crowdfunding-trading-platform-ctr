...
import AdminProjectEditRequestDetail from "./pages/admin/ProjectEditRequestDetail";
import AdminAccessRequests from "./pages/admin/AccessRequests";
import AdminUsers from "./pages/admin/Users";
import AdminUserDetail from "./pages/admin/UserDetail";
import AdminInvestments from "./pages/admin/Investments";
import AdminInvestmentProjectDetail from "./pages/admin/InvestmentProjectDetail";
import AdminInvestmentRequests from "./pages/admin/InvestmentRequests";
import AdminInvestmentApprovals from "./pages/admin/InvestmentApprovals";
import AdminPayments from "./pages/admin/Payments";
import AdminAuditLogs from "./pages/admin/AuditLogs";
import AdminProjectLedger from "./pages/admin/ProjectLedger";
import AdminProjectLedgerDetail from "./pages/admin/ProjectLedgerDetail";
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/app/developer" element={<RequireAuth><DeveloperLayout /></RequireAuth>}>
            ...
            <Route path="projects/archived" element={<DeveloperProjects />} />
          ...
          <Route path="/app/admin" element={<RequireAuth><AdminLayout /></RequireAuth>}>
            ...
            <Route path="projects/edit-requests/:id" element={<AdminProjectEditRequestDetail />} />
            <Route path="access-requests" element={<AdminAccessRequests />} />
            <Route path="users" element={<AdminUsers />} />
            <Route path="users/:id" element={<AdminUserDetail />} />
            <Route path="investments/requests" element={<AdminInvestmentRequests />} />
            <Route path="investments/processing" element={<AdminInvestmentApprovals />} />
            <Route path="investments" element={<AdminInvestments />} />
            <Route path="investments/projects/:id" element={<AdminInvestmentProjectDetail />} />
            <Route path="payments" element={<AdminPayments />} />
            <Route path="projects/ledger" element={<AdminProjectLedger />} />
            <Route path="projects/ledger/:id" element={<AdminProjectLedgerDetail />} />
